...
const TopRankingCard = () => {
  ...
  return (
    <div className="toprankingcontainer">
      <h4 className="title text-3xl font-bold pb-2 text-defaut-color-pink hover:cursor-default">
        Top Ranking
      </h4>
      <div className="cardcontainers w-[1200px] flex justify-around h-[400px]  ">
