...
const LoginPage = () => {
  return (
    <div className="flex justify-center">
      <div class="register_form padding_default shadow_sm w-[450px] px-[24px] py-[30px]">
        <h4 class="title_2 text-2xl font-semibold uppercase pb-2">
          Create an account
        </h4>
            ...
            <div class="col-12 mt-2">
              <div class="custom_check check_2 d-flex align-items-center">
                ...
                <label for="save-default">
                  ...
                  <a href="terms-condition.html" class="text-color">
                    terms &amp; conditions
                  </a>{" "}
                </label>
              </div>
        ...
        <p class="text-center mt-3 mb-0">
          ...
          <a href="login.html" class="text-color">
            Login Now
          </a>
        </p>
      </div>
