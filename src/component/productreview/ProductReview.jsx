        ...
        <div>
          ...
          <div hidden={showDetail !== "Review"}>
            ...
            <div className="review_cont_wrap">
              <div className="single_review_wrp flex border-b-2 pb-10 mb-10 ">
